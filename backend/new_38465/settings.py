"""
Django settings for new_38465 project.
...
WSGI_APPLICATION = 'new_38465.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_38465 API",
    "DESCRIPTION": "API documentation for new_38465 App",
    "VERSION": "v1",
}
